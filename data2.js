...
window.CENDRA_DATA2 = {
  ...
  // Cendra's prospective plan · what Cendra will do if PM steps away
  // for the next 4 hours. Audit §7 — the "trust killer" forward replay.
  cendra_plan_4h: {
    window_label: "Next 4 hours · until 19:00",
    summary: "Cendra will handle 11 routine actions, draft 4 for your review, and pause on 2 items it knows you need to see.",
    auto_count: 11,
    draft_count: 4,
    hold_count: 2,
    items: [
      { id: "pl1", time: "15:30", property: "Karaköy · Apt 12", action: "Auto-send Wi-Fi to Lukas after check-in", mode: "auto",   tier: "T5" },
      { id: "pl2", time: "15:45", property: "Studio Galata",   action: "Auto-confirm parking-available reply to Nora", mode: "auto", tier: "T5" },
      { id: "pl3", time: "16:00", property: "Studio Galata",   action: "Greet Nora on arrival (warmth tone, EN+DE)",       mode: "auto",  tier: "T5" },
      { id: "pl4", time: "16:30", property: "Beşiktaş 7",      action: "Release access code to Hana (T-2h policy)",        mode: "auto",  tier: "T5" },
      { id: "pl5", time: "16:30", property: "Bosphorus Loft",  action: "Send fulfillment update to Selin (plumber done)",  mode: "draft", tier: "T4", reason: "Promised by 09:02 — Cendra will auto-recall in 60s if you don't approve" },
      { id: "pl6", time: "17:00", property: "Bosphorus Loft",  action: "Notify owner Aylin of resolved leak",              mode: "auto",  tier: "T5" },
      { id: "pl7", time: "17:00", property: "Cihangir House",  action: "Late checkout offer to Élise · €25 default",       mode: "draft", tier: "T4", reason: "Recall window 60s · you can pull back" },
      { id: "pl8", time: "17:30", property: "Galata 3",        action: "AC verify report from maintenance · forward to Thomas", mode: "draft", tier: "T3", reason: "Draft holds for your review · refund decision pending" },
      { id: "pl9", time: "—",     property: "—",               action: "Watch all 31 active conversations · escalate hostile shifts",   mode: "auto",  tier: "T5" },
      { id: "pl10", time: "—",    property: "—",               action: "Apply recency decay to property facts older than 90 days",     mode: "auto",  tier: "T5" },
      { id: "pl11", time: "16:50",property: "Cihangir House",  action: "Daily owner report draft → Selin Çelik",            mode: "draft", tier: "T3", reason: "Held for your sign-off (weekly cadence)" },
      { id: "pl12", time: "—",    property: "Galata 3",        action: "Thomas refund decision · hold until you decide",   mode: "hold",  tier: "T0", reason: "GDPR Art.22 · cannot auto-decide" },
      { id: "pl13", time: "—",    property: "Bosphorus Loft",  action: "Damage claim file decision · hold",                mode: "hold",  tier: "T0", reason: "Never-auto category · always human" },
    ],
  },

  // Owners · portfolio stakeholders. Audit §6 — owner relationship pulse.
  owners_pulse: [
    {
      id: "own_karakoy",
      name: "Karaköy LLC",
      primary_contact: "Mehmet Demir",
      properties: 4,
      open_approvals: 0,
      avg_response_min: 23,
      typical_response_min: 30,
      sentiment_30d: "warm",
      last_interaction: "Yesterday · approved €40 cleaner overtime",
      health: "healthy",
      note: "Responsive · honors Wednesday gardener schedule",
    },
    {
      id: "own_bosphorus",
      name: "Bosphorus Holdings",
      primary_contact: "Aylin Yıldız",
      properties: 3,
      open_approvals: 2,
      avg_response_min: 14,
      typical_response_min: 9,
      sentiment_30d: "concerned",
      last_interaction: "08:14 today · acknowledged plumber dispatch",
      health: "needs_attention",
      note: "Response slowed this week · stay extra warm on leak follow-up",
    },
    {
      id: "own_galata",
      name: "Galata Estates",
      primary_contact: "Serhat Aydın",
      properties: 4,
      open_approvals: 1,
      avg_response_min: 145,
      typical_response_min: 90,
      sentiment_30d: "tense",
      last_interaction: "2d ago · pushed back on €40 goodwill",
      health: "at_risk",
      note: "Refund discussion (€120 · Thomas) escalating · review window opens 14h",
    },
    {
      id: "own_cihangir",
      name: "Cihangir Living",
      primary_contact: "Selin Çelik",
      properties: 9,
      open_approvals: 0,
      avg_response_min: 47,
      typical_response_min: 60,
      sentiment_30d: "warm",
      last_interaction: "3d ago · approved weekly playbook digest",
      health: "healthy",
      note: "Light touch portfolio · trusts auto-late-checkout pattern",
    },
    {
      id: "own_independent",
      ...
      properties: 8,
      open_approvals: 0,
      avg_response_min: 180,
      typical_response_min: 200,
      sentiment_30d: "neutral",
      last_interaction: "—",
      health: "healthy",
      note: "Self-managed units · Cendra coordinates with each contact directly",
    },
  ],
  ...
  vendors: [
    {
      ...
      rating: 4.8,
      status: "on_site",
      current_job: { property: "Bosphorus Loft", scope: "Bathroom leak", eta: "11:20", since: "08:14" },
      open_jobs: 1,
      overdue: 0,
      tone: "warn",
      channels: ["phone", "whatsapp"],
      last_touch: "ETA 11:20 confirmed · 26m ago",
    },
    {
      id: "vn_galata_maint",
      name: "Galata Maintenance",
      ...
      rating: 4.5,
      status: "promised",
      current_job: { property: "Galata 3", scope: "AC verify on departure", eta: "13:00", since: "06:14" },
      open_jobs: 1,
      overdue: 0,
      tone: "info",
      channels: ["email"],
      last_touch: "Promised by 13:00 · 7h ago",
    },
    {
      id: "vn_marta",
      name: "Marta Costa",
      trade: "Cleaner",
      coverage: ["Beyoğlu", "Karaköy"],
      avg_response_min: 8,
      avg_arrival_min: 35,
      jobs_30d: 41,
      success_rate: 0.99,
      rating: 4.95,
      status: "on_site",
      current_job: { property: "Karaköy · Apt 12", scope: "Cleaning · same-day turnover", eta: "14:30", since: "13:00" },
      open_jobs: 1,
      overdue: 0,
      tone: "ok",
      channels: ["whatsapp"],
      last_touch: "On site · 30m ago",
    },
    {
      id: "vn_locksmith",
      name: "İzlemir Lockworks",
      trade: "Locksmith",
      coverage: ["Beyoğlu", "Bosphorus", "Cihangir", "Galata", "Beşiktaş"],
      avg_response_min: 18,
      avg_arrival_min: 50,
      jobs_30d: 5,
      success_rate: 0.97,
      ...
      tone: "ok",
      channels: ["phone"],
      last_touch: "Standby · last job 8d ago",
    },
    {
      id: "vn_gardener",
      name: "Cihangir Garden",
      trade: "Gardener",
      coverage: ["Cihangir", "Karaköy"],
      avg_response_min: 4 * 60,
      avg_arrival_min: 24 * 60,
      jobs_30d: 4,
      success_rate: 0.95,
      rating: 4.6,
      status: "scheduled",
      current_job: { property: "Karaköy · Apt 4", scope: "Weekly garden maintenance", eta: "Wed 09:00", since: "scheduled 3d ago" },
      open_jobs: 1,
      overdue: 0,
      tone: "info",
      channels: ["email", "phone"],
      last_touch: "Confirmed Wed 09:00",
    },
    {
      id: "vn_bcleaners",
      name: "Bosphorus Cleaners",
      trade: "Cleaner",
      coverage: ["Bosphorus", "Beşiktaş"],
      avg_response_min: 18,
      avg_arrival_min: 120,
      jobs_30d: 22,
      success_rate: 0.92,
      rating: 4.4,
      status: "overdue",
      current_job: { property: "Bosphorus Loft", scope: "Cleaning · standard", eta: "11:00", since: "11:30" },
      open_jobs: 1,
      overdue: 1,
      tone: "risk",
      channels: ["whatsapp", "phone"],
      last_touch: "ETA missed · 32m ago · no reply",
    },
  ],
  ...
  workflow_groups: [
    {
      ...
      workflows: [
        ...
        { id: "wf_recs",   name: "Local recommendations",        state: "draft_hold",samples: 77,  override: "2.6%", incidents: 0,  hold_min: 3,   scope: "portfolio", last: "—",                default: "Draft & send",      ready: false, why: "Need 30 more samples for autopilot." },
      ],
    },
    {
      ...
      workflows: [
        ...
        { id: "wf_late",   name: "Late checkout offer",           state: "recall",    samples: 96,  override: "0.0%",  incidents: 0, hold_min: 0,   recall_sec: 60, scope: "portfolio", last: "Promoted to recall 6d ago", default: "Offer €25",      ready: true,  why: "Promotion ready: 96 cases, 0 overrides, 0 incidents in 30d." },
        { id: "wf_clean",  name: "Housekeeping coordination",     state: "draft_hold",samples: 184, override: "1.6%",  incidents: 0, hold_min: 5,   scope: "portfolio", last: "—",                 default: "Ping cleaner",   ready: false, why: "Held in draft until cleaning sync stabilises." },
        { id: "wf_maint",  name: "Maintenance triage",            state: "draft_hold",samples: 64,  override: "3.1%",  incidents: 1, hold_min: 5,   scope: "portfolio", last: "Demoted 4d ago",    default: "Photo → vendor", ready: false, why: "1 misclassified leak. Hold for 7 more days." },
    ...
    },
    {
      ...
      workflows: [
        { id: "wf_late_up",name: "Late checkout upsell",          state: "recall",    samples: 143, override: "0.0%", incidents: 0, hold_min: 0,  recall_sec: 60, scope: "portfolio", last: "Promoted to recall 4d ago", default: "Offer €25", ready: true, why: "Same family as late checkout offer. Stable." },
        { id: "wf_extend", name: "Stay extension",                state: "draft_hold",samples: 76,  override: "1.3%", incidents: 0, hold_min: 5,   scope: "portfolio", last: "—", default: "Match nightly", ready: false, why: "Held until pricing rule for high season is set." },
    ...
    },
    {
      ...
      workflows: [
        ...
        { id: "wf_owner_wk",  name: "Weekly owner report",          state: "draft_hold",samples: 24,   override: "—",    incidents: 0, hold_min: 30,scope: "portfolio", last: "—", default: "Send Friday 17:00", ready: true, why: "Promotion ready." },
    ...
    checking_out_today: [
      {
        ...
        messages: [
          ...
          { id: "e4", kind: "system", time: "Yesterday 21:02", body: "Cross-channel match · merged with confidence Medium · evidence: same phone hash + 3 shared behavioural features (response cadence, tone, language)", tone: "info" },
