...
window.CENDRA_DATA = {
  ...
  learnings: [
    ...
    {
      id: "l4",
      refusal_type: "documents",
      title: "Don't quote a refund without on-record evidence — even when guest is escalating.",
      observed: "You held the line in 5 of 5 Galata Estates refund cases this quarter when photos weren't provided.",
      examples: 5, overrides: 0, incidents: 0, confidence: 0.88,
      proposed: "Approval gate, owner scope (Galata Estates). Refund > €100 requires photo_received=true. Mode: approval-required.",
      simulation: { passed: 5, failed: 0, would_change: "All 5 historical refunds would have routed to approval as-is." },
      risk: "low",
    },
    {
      id: "l5",
      refusal_type: "owner_approval",
      title: "Don't auto-dispatch vendors over €150 for Bosphorus Holdings without Aylin's text-back.",
      observed: "You re-routed 3 vendor quotes in 30d that Cendra wanted to auto-dispatch. Aylin replied within 12 min each time.",
      examples: 3, overrides: 3, incidents: 0, confidence: 0.79,
      proposed: "Owner policy, scope: Bosphorus Holdings. Vendor dispatch > €150 ⇒ WhatsApp Aylin, 15-min wait, then escalate.",
      simulation: { passed: 3, failed: 0, would_change: "Avg dispatch wait: 5m → 14m. Owner-touch confidence boost on quotes." },
      risk: "low",
    },
    {
      id: "l6",
      refusal_type: "compliance",
      title: "GDPR Art.22 — never auto-decide refunds for natural persons over €100 without human review.",
      observed: "You signed off on 11 such decisions in 30d. Cendra correctly held all 11 for review.",
      examples: 11, overrides: 0, incidents: 0, confidence: 0.97,
      proposed: "Compliance hard rule, portfolio. Already wired via ComplianceMonitor — surface in Trust → Compliance.",
      simulation: { passed: 11, failed: 0, would_change: "No behavior change. Adds explicit compliance label on cards." },
      risk: "low",
    },
    {
      id: "l7",
      refusal_type: "ambiguity",
      title: "When two different sources disagree about a property fact, ask before sending.",
      observed: "Karaköy 12 bedroom count is in conflict — cleaner says 1 king + sofa-bed, listing says 1 queen. Cendra deferred 4 times in 14d.",
      examples: 4, overrides: 0, incidents: 0, confidence: 0.82,
      proposed: "Abstention rule. When fact.state == 'conflict' and used_in_workflow, default to abstention card with both sources.",
      simulation: { passed: 4, failed: 0, would_change: "Same behavior · ensures consistency portfolio-wide." },
      risk: "low",
    },
  ],
